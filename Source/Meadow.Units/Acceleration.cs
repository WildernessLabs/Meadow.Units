    ...
    IEquatable<double>, IComparable<double>
{
    ...
    [Pure] public int CompareTo(Acceleration other) => Equals(Value, other.Value) ? 0 : Value.CompareTo(other.Value);
    ...
    /// </summary>
    /// <returns></returns>
    [Pure] public Acceleration Abs() { return new Acceleration(Math.Abs(Value)); }
