...
{
    /// <summary>
    /// Creates a new <see cref="AngularVelocity3D"/> object.
    /// </summary>
    ...
    {
        X = new AngularVelocity(angularVelocity3D.X);
        Y = new AngularVelocity(angularVelocity3D.Y);
        Z = new AngularVelocity(angularVelocity3D.Z);
    }
    ...
    {
        if (obj is AngularVelocity3D angularVelocity3D)
        {
            return X.CompareTo(angularVelocity3D.X) |
                   Y.CompareTo(angularVelocity3D.Y) |
                   Z.CompareTo(angularVelocity3D.Z);
        }

        throw new ArgumentException("Object is not an AngularVelocity3D");
    }
