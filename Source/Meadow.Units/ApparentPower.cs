...
namespace Meadow.Units
{
        ...
        IEquatable<double>, IComparable<double>
    {
        ...
        public ApparentPower(double value, UnitType type = UnitType.VoltAmpheres)
        {
            Value = ApparentPowerConversions.Convert(value, type, UnitType.VoltAmpheres);
        }

        /// <summary>
        /// Creates a new `ApparentPower` object from an existingApparentPower object
        /// </summary>
        ...
        {
            return ApparentPowerConversions.Convert(Value, UnitType.VoltAmpheres, convertTo);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ApparentPower)obj);
        }
        ...
        /// <summary>
        /// Not equals operator to compare twoApparentPower objects
        /// </summary>
        /// <param name="left">left value</param>
        /// <param name="right">right value</param>
        ...
        /// <summary>
        /// Compare to anotherApparentPower object
        /// </summary>
        ...
        /// <summary>
        /// Less than operator to compare twoApparentPower objects
        /// </summary>
        /// <param name="left">left value</param>
        /// <param name="right">right value</param>
        ...
        /// <summary>
        /// Greater than operator to compare twoApparentPower objects
        /// </summary>
        /// <param name="left">left value</param>
        /// <param name="right">right value</param>
        ...
        /// <summary>
        /// Less than or equal operator to compare twoApparentPower objects
        /// </summary>
        /// <param name="left">left value</param>
        /// <param name="right">right value</param>
        ...
        /// <summary>
        /// Greater than or equal operator to compare twoApparentPower objects
        /// </summary>
        /// <param name="left">left value</param>
        /// <param name="right">right value</param>
        ...
        // Math
        /// <summary>
        /// Addition operator to add twoApparentPower objects
        /// </summary>
        /// <param name="left">left value</param>
        /// <param name="right">right value</param>
        ...
        /// <summary>
        /// Subtraction operator to subtract twoApparentPower objects
        /// </summary>
        /// <param name="left">left value</param>
        /// <param name="right">right value</param>
        /// <returns>A new ApparentPower object with a value of left - right</returns>
        ...
        /// </summary>
        /// <returns></returns>
        [Pure] public ApparentPower Abs() { return new ApparentPower(Math.Abs(this.Value)); }
        ...
        /// Compare to anotherApparentPower object
        /// </summary>
        /// <param name="obj">The otherApparentPower cast to object</param>
        /// <returns>0 if equal</returns>
