...
/// <summary>
/// Represents a value of Inductance - the property of an electrical conductor that opposes changes in current flow.
/// </summary>
[Serializable]
    ...
    IEquatable<double>, IComparable<double>
{
    ...
    /// <returns>true if equal</returns>
    [Pure] public bool Equals(Inductance other) => Value == other.Value;

    /// <summary>
    /// Equals operator to compare two Inductance objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    /// <returns>true if equal</returns>
    [Pure] public static bool operator ==(Inductance left, Inductance right) => Equals(left.Value, right.Value);

    /// <summary>
    /// Not equals operator to compare two Inductance objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    ...
    [Pure] public int CompareTo(Inductance other) => Equals(Value, other.Value) ? 0 : Value.CompareTo(other.Value);

    /// <summary>
    /// Less than operator to compare two Inductance objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    /// <returns>true if left is less than right</returns>
    [Pure] public static bool operator <(Inductance left, Inductance right) => Comparer<double>.Default.Compare(left.Value, right.Value) < 0;

    /// <summary>
    /// Greater than operator to compare two Inductance objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    ...
    /// <summary>
    /// Less than or equal operator to compare two Inductance objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    ...
    /// <summary>
    /// Greater than or equal operator to compare two Inductance objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    ...
    // Math
    /// <summary>
    /// Addition operator to add two Inductance objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    /// <returns>A new Inductance object with a value of left + right</returns>
    [Pure] public static Inductance operator +(Inductance left, Inductance right) => new(left.Value + right.Value);

    /// <summary>
    /// Subtraction operator to subtract two Inductance objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    /// <returns>A new Inductance object with a value of left - right</returns>
    ...
    /// <returns>A new Inductance object with a value of value multiplied by the operand</returns>
    [Pure] public static Inductance operator *(Inductance value, double operand) => new(value.Value * operand);
    ...
    /// <returns>A new Inductance object with a value of value divided by the operand</returns>
    [Pure] public static Inductance operator /(Inductance value, double operand) => new(value.Value / operand);

    /// <summary>
    /// Returns the absolute value of the <see cref="Inductance"/>
    /// </summary>
    /// <returns></returns>
    [Pure] public Inductance Abs() { return new Inductance(Math.Abs(Value)); }
