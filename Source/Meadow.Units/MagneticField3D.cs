...
{
    /// <summary>
    /// Creates a new <see cref="MagneticField3D"/> object.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="MagneticField3D"/> object from an existing object.
    /// </summary>
    /// <param name="magneticField3D">Source object</param>
    public MagneticField3D(MagneticField3D magneticField3D)
    {
        X = new MagneticField(magneticField3D.X);
        Y = new MagneticField(magneticField3D.Y);
        Z = new MagneticField(magneticField3D.Z);
    }
    ...
    // Math
    /// <summary>
    /// Addition operator to add two MagneticField3D objects
    /// </summary>
    /// <param name="left">left value</param>
    /// <param name="right">right value</param>
    ...
    public int CompareTo(object obj)
    {
        ...
        throw new ArgumentException("Object is not a MagneticField3D");
    }
