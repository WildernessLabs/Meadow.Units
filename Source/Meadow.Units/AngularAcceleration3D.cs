...
{
    /// <summary>
    /// Creates a new <see cref="AngularAcceleration3D"/> object.
    /// </summary>
    /// <param name="valueX">The X AngularAcceleration value.</param>
    /// <param name="valueY">The Y AngularAcceleration value.</param>
    /// <param name="valueZ">The Z AngularAcceleration value.</param>
    ...
    /// <summary>
    /// Creates a new <see cref="AngularAcceleration3D"/> object from an existing object.
    /// </summary>
    ...
    {
        X = new AngularAcceleration(angularAcceleration3D.X);
        Y = new AngularAcceleration(angularAcceleration3D.Y);
        Z = new AngularAcceleration(angularAcceleration3D.Z);
    }
    ...
    {
        if (obj is AngularAcceleration3D angularAcceleration3D)
        {
            return X.CompareTo(angularAcceleration3D.X) | Y.CompareTo(angularAcceleration3D.Y) | Z.CompareTo(angularAcceleration3D.Z);
        }

        throw new ArgumentException("Object is not an AngularAcceleration3D");
    }
